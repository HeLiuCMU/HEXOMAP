    ...
    def test_recon_1(self):
        ...
        for i in range(10):
            ...
            if i>0:
                ...
                self.orientationMat = FZfile.random_angle_around_mat(maxMat,self.NOrientation//NSelect+1,0.5/i,'Hexagonal')[:self.NOrientation,:,:]
        ...
        print('top 10 hit ratio: {0}, hit cnt: {1}'.format(self.afHitRatioH[:10], self.aiPeakCntH[:10]))
